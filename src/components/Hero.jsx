...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative overflow-hidden pt-32 sm:pt-44 pb-20 bg-gradient-to-br from-pink-50 via-white to-blue-50"
    >
      {/* Background Blur Shapes */}
      <div className="absolute -top-24 -left-24 w-96 h-96 bg-pink-200 rounded-full blur-3xl opacity-30" />
