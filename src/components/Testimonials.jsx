      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-teal-50 to-blue-50 p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow relative"
            >
        ...
        <div className="mt-16 bg-gradient-to-r from-teal-600 to-blue-600 rounded-2xl p-8 text-center text-white">
          <h3 className="text-3xl font-bold mb-4">Join Thousands of Satisfied Patients</h3>
          <p className="text-xl mb-6 opacity-90">Experience compassionate care and medical excellence</p>
