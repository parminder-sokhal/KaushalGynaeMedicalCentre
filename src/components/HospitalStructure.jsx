...
const HospitalStructure = () => {
  return (
    <>
      <div className="container gap-4 mx-auto pb-10 pt-10 py-5 px-10 lg:px-40">
        <div className="text-center mb-10">
          <h2 className="flex justify-start text-4xl text-gray-800 ">
            Hospital Structure
          </h2>
        </div>
        ...
        <h3 className="font-bold text-xl text-gray-800 mb-2">NABH ACCREDITED HOSPITAL</h3>
          ...
          {/* Box 2 */}
          <div className="flex-1 bg-green-100 rounded-md p-4 mx-2 text-center shadow-sm flex items-center justify-center">
            <div>
              <h3 className="font-bold text-xl text-gray-800 mb-2">15</h3>
        ...
        <p className="text-gray-600 font-bold">OT</p>
          ...
          {/* Box 4 */}
          <div className="flex-1 bg-green-200 rounded-md p-4 mx-2 text-center shadow-sm flex items-center justify-center">
            <div>
              <h3 className="font-bold text-xl text-gray-800 mb-2">
                Private Room
              </h3>
