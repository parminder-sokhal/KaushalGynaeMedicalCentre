      ...
      <div className="bg-teal-600 text-white py-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center text-sm">
          <div className="flex items-center gap-6">
            <a href="tel:9855738386" className="flex items-center gap-2 hover:text-teal-200">
              <Phone size={16} />
              <span>9855738386</span>
            </a>
            <a href="mailto:drkaushalruchita@gmail.com" className="flex items-center gap-2 hover:text-teal-200">
              <Mail size={16} />
