      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-6 py-16 grid lg:grid-cols-4 gap-12">
        ...
        <div className="lg:col-span-3 space-y-10 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              We provide complete maternity care for both Normal Vaginal Delivery
              and Caesarean Section, combining modern medical facilities with
              compassionate, patient-centered care for a safe and positive
