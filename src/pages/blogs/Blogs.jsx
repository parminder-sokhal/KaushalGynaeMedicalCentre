  ...
  return (
    <div className="container mx-auto mt-20 px-6 sm:px-10 md:px-14 lg:px-20 py-10">
      <div className="py-10 flex flex-row items-center justify-between">
        <h1 className="sm:text-6xl text-3xl font-semibold text-pink-500 text-start">
          Blogs
        </h1>
        <input
          type="text"
          ...
          className="w-1/2 sm:w-1/3 px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-pink-400"
        />
      </div>
